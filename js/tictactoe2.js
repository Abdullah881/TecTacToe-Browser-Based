...
let selectedSquares = [];
var GameOver = false // Var states is game is active or not 
// this variable prevents a player from playing a move if the other player has won
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))){
        ...
        // computer will not play if X has won, without GameOver == false
        // O would play a turn even after X has won
        if (activePlayer == "O" && GameOver == false) {
            disableClick();
